...
$7zFilePath = Join-Path $outputDir "DeveReproduceXmlSerializerBug.7z"
$zipFilePath = Join-Path $outputDir "DeveReproduceXmlSerializerBug.zip"

DeleteFileIfExists $7zFilePath
DeleteFileIfExists $zipFilePath
DeleteFolderIfExists $outputDir

$buildPath = Join-Path $solutionRoot "DeveReproduceXmlSerializerBug\bin\Release\net6.0"
